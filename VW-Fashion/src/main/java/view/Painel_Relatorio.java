...
public class Painel_Relatorio extends JPanel{
	...
	public void addLabel() {
	 MeuJLabel relatorio = new MeuJLabel(370, 2, 100, 15, "Relatorio");	
	...
	public void addJTable() {
		...
		modeloTabela.addColumn("Vendedor");
		modeloTabela.addColumn("Total");
		modeloTabela.addColumn("Valor Final");
	...
	public void addComboBox() {
		...
		String[] meses = {"Janeiro 2023", "Fevereiro 2023", "Março 2023"};		
	...
	public static void main(String[] args) {
		Janela.setPanel(new Painel_Relatorio());
